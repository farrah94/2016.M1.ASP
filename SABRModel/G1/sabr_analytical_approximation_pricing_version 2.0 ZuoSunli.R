...
sabr.kennedy<-function(r,t,sigma0.normal,sigma0.lognormal,s0,alpha,beta,rho,k){
  #ghq
  ...
  if(beta==0){
    ...
    return(call.price.normal.analytical)
    ...
    return(call.price.lognormal.analytical)
...
for(k in 50:150){
  call.price[k-50+1]<-sabr.kennedy(r,t,sigma0.normal,sigma0.lognormal,s0,alpha,beta,rho,k)
}

k<-c(50:150)

plot(k,call.price,main="Kennedy's Approximation")
lines(k,call.price,type="l")

sabr.kennedy(r,t,sigma0.normal,sigma0.lognormal,s0,alpha,beta,rho,k)
